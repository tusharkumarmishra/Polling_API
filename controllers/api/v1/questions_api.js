...
Description 	Create a question (you can add as many questions as you want)  // dekho yahan 3 chij pass hoga discription/
Access          PUBLIC
Methods         POST 
*/
...
Methods        POST 
*/
// http://localhost:8200/api/v1/questions/id/options/create
module.exports.createOption = async (req, res) => {
    ...
    try {
        ...
        if (question) {
            ...
            option.link_to_vote = "http://localhost:8200/api/v1/options/" + option._id + "/addVote";
